...
```
* Префиксния оператор инкрементира стойността на променливата и връща **променливата**.
* Постфиксния оператор инкрементира променливата и връща нейната **стара** стойност.

Тук отново забелязваме, че единия опетарот връща променлива а другия стойност. Как можем да проверим това нагледно?
